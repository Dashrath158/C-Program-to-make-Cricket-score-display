...
int main()
{
	...
	char thnk[]="===========================================================================================\n\tTHANK YOU\n \tThis project was completed by our team including Dashrath, Rachit,Hitesh,Vanshika \n===========================================================================================\n\n";
  ...
  for(i=0;i<m;i++)
   {
       ...
       printf("\n	Name of batsman %d: ",i+1);
       scanf("%s",pl1[i].name); 
       //gets(pl1[i].name);

       printf("\n	Number of ones scored by player%d: ",i+1);
       scanf("%d",&pl1[i].ones);


       printf("\n	Number of twos scored by player%d: ",i+1);
       scanf("%d",&pl1[i].twos);


       printf("\n	Number of threes scored by player%d: ",i+1);
       scanf("%d",&pl1[i].threes);


       printf("\n	Number of fours scored by player%d: ",i+1);
       scanf("%d",&pl1[i].fours);


       printf("\n	Number of sixes scored by player%d: ",i+1);
       scanf("%d",&pl1[i].sixes);


       printf("\n	Total no. of balls played by the player%d:",i+1);
       scanf("%d",&pl1[i].balls);
  printf("\n==============================================\n");
